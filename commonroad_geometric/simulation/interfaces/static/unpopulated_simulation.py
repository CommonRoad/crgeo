...
from commonroad_geometric.common.io_extensions.scenario import backup_scenario  # noqa
...
class UnpopulatedSimulationOptions(BaseSimulationOptions):
    pass


class UnpopulatedSimulation(BaseSimulation[UnpopulatedSimulationOptions]):
    def __init__(
        self,
        initial_scenario: Union[Scenario, Path],
        options: Optional[UnpopulatedSimulationOptions] = None
    ) -> None:
        """

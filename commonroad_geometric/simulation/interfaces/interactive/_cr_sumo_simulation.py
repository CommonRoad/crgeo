...
from commonroad_geometric.external.sumocr.interface.ego_vehicle import EgoVehicle
from commonroad_geometric.external.sumocr.interface.util import *
from commonroad_geometric.external.sumocr.maps.scenario_wrapper import AbstractScenarioWrapper
from commonroad_geometric.external.sumocr.sumo_config import DefaultConfig, EGO_ID_START
from commonroad_geometric.external.sumocr.sumo_config.pathConfig import SUMO_GUI_BINARY
...
class _CRSumoSimulation(AutoReprMixin):
    ...
    def __init__(self, silent: bool = True, include_lanes: set[int] = None,):
        ...
        from commonroad_geometric.external.sumocr.converter import CR2SumoMapConverter

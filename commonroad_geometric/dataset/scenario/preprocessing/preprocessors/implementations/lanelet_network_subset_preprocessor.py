...
class LaneletNetworkSubsetPreprocessor(ScenarioPreprocessor):
    """
    ...
    def __init__(
        ...
        # TODO: remove vehicles outside of map subset
    ...
    def _process(self, scenario_bundle: ScenarioBundle) -> T_ScenarioPreprocessorResult:
        ...
        for lanelet in scenario.lanelet_network.lanelets:
            if ((not lanelet.predecessor or not lanelet.successor)
                and lanelet.distance[-1] < self.min_leaf_lanelet_length):

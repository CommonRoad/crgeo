...
import commonroad_geometric.external.sumocr as sumocr
# set installation locations
SUMO_GUI_BINARY = os.path.join(os.path.expanduser(os.environ['SUMO_HOME']), 'bin', 'sumo-gui') if sumocr.sumo_installed else None

# path to binary of adapted sumo repository (see readme)
SUMO_BINARY = os.path.join(os.path.expanduser(os.environ['SUMO_HOME']), 'bin', 'sumo') if sumocr.sumo_installed else None

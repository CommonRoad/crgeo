...
from commonroad_geometric.common.io_extensions.mock_objects import create_dummy_scenario
...
class TestLaneletNetwork(unittest.TestCase):
    ...
    def test_segment_lanelets_deterministic(self):
        ...
        scenario, planning_problem_set = CommonRoadFileReader('./commonroad_geometric/tests/io_extensions/USA_US101-26_1_T-1.xml').open()

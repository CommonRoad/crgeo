from typing import Callable, Dict, Set, Tuple, Union, TYPE_CHECKING
...
from crgeo.common.geometry import ContinuousPolyline
from crgeo.common.geometry.helpers import chaikins_corner_cutting, cut_polyline, resample_polyline
from crgeo.dataset.extraction.road_network.types import LaneletEdgeType, LaneletNodeType

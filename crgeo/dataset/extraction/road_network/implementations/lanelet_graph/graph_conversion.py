...
from crgeo.common.geometry.helpers import TWO_PI, chaikins_corner_cutting, relative_orientation, resample_polyline, rotate_2d_matrix
from crgeo.dataset.extraction.road_network.types import GraphConversionStep, LaneletEdgeType, LaneletNodeType

if TYPE_CHECKING:
    from crgeo.dataset.extraction.road_network.implementations.lanelet_graph.road_renderer import RoadRenderer
...
class LaneletGraphConverter:
    ...
    def render_road_coverage(
        ...
        if renderer_cls is None:
            from crgeo.dataset.extraction.road_network.implementations.lanelet_graph.road_renderer import \
...
def compute_curvature_from_polyline(polyline: np.ndarray) -> np.ndarray:
    # adapted from crgeo/external/commonroad_route_planner/utility/route.py

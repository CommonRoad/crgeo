...
from typing import Any, Dict, Generic, List, Optional, Set, TypeVar, TYPE_CHECKING
...
from crgeo.common.utils.functions import get_function_return_variable_name
from crgeo.dataset.extraction.traffic.exceptions import TrafficExtractionException
from crgeo.dataset.extraction.traffic.feature_computers.types import BaseFeatureParams, FeatureDict, FeatureValue, T_FeatureCallable, T_FeatureParams
from crgeo.dataset.extraction.traffic.feature_computers.utils.init_mock_setup import _init_mock_setup
...
class BaseFeatureComputer(ABC, Generic[T_FeatureParams], SafePicklingMixin, AutoReprMixin, StringResolverMixin):    
    ...
    """
    Base class for computing features to be included as attributes in the CommonRoadData instances. 
    Feature computer is easily customizable by subclassing and implementing the call protocol.
    """

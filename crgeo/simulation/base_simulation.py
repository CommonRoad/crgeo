...
from typing import Any, Dict, Iterable, Iterator, List, Optional, Set, Tuple, TypeVar, Union, overload, TYPE_CHECKING
...
from crgeo.common.io_extensions.obstacle import get_obstacle_lanelet_assignment, state_at_time
from crgeo.common.io_extensions.scenario import LANELET_ASSIGNMENT_STRATEGIES_CENTER, LANELET_ASSIGNMENT_STRATEGIES_SHAPE, LaneletAssignmentStrategy, backup_scenario, \
...
from crgeo.dataset.extraction.road_network.types import GraphConversionStep
from crgeo.rendering.traffic_scene_renderer import T_Frame, TrafficSceneRenderer
from crgeo.rendering.types import RenderParams, Renderable, T_RendererPlugin
from crgeo.simulation.ego_simulation.ego_vehicle import EgoVehicle
from crgeo.simulation.exceptions import SimulationNotYetStartedException, SimulationRuntimeError
from crgeo.simulation.lanelet_network_info import LaneletNetworkInfo
...
class BaseSimulation(Renderable, Iterator[Tuple[int, Scenario]], LaneletNetworkInfo, StringResolverMixin):
    ...
    def num_time_steps(self) -> int:
        if self.final_time_step is Unlimited:
            return sys.maxsize
        return self.final_time_step - self.initial_time_step
